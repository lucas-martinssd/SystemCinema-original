...
public class Carrinho {
    ...
    public List<Integer> getPoltronasSelecionadas() { return poltronasSelecionadas; }
    public void setPoltronasSelecionadas(List<Integer> poltronasSelecionadas) { this.poltronasSelecionadas = poltronasSelecionadas; }

    public List<Produto> getProdutosSelecionados() { return produtosSelecionados; }
    public void setProdutosSelecionados(List<Produto> produtosSelecionados) { this.produtosSelecionados = produtosSelecionados; }

    public Map<Produto, Integer> getQuantidadeProdutos() { return quantidadeProdutos; }
    public void setQuantidadeProdutos(Map<Produto, Integer> quantidadeProdutos) { this.quantidadeProdutos = quantidadeProdutos; }
